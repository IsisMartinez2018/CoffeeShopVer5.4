...
<div id="page-wrap">
      @if( Session::has( 'alert' ))
                     <div class="alert alert-success" style="width: 1250px; margin-left: -400px; margin-top: -20px;"><img src="{{ url('svg/checked.svg') }}" style="width: 20px; height: 23px">
                    {{ Session::get( 'alert' ) }}
                     </div>
                    @endif
        ...
        <div id="contact-info" class="vcard">
            ...
            <h1 class="fn">Perfil de usuario &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
               ...
               <a class="fb" href="{{ url ('https://www.facebook.com/'.$profile->facebook)}}" style="border-bottom-style: solid; color: #007bff;">           
                 <img src="{{ url('svg/facebook.svg') }}" style="width: 20px; height: 23px"></a>
                            
                            
                <a class="fb1" href="{{ url ('https://www.twitter.com/'.$profile->twitter)}}" style="border-bottom-style: solid; color: #3bbef5;"> 
               <img src="{{ url('svg/twitter.svg') }}" style="width: 20px; height: 23px"></a>
                            
                           
                <a class="fb2" href="{{ url ('https://plus.google.com/'.$profile->google)}}" style="border-bottom-style: solid; color: #ea5d4b;"> 
                <img src="{{ url('svg/google-plus.svg') }}" style="width: 20px; height: 23px"></a>
                            
                 <a class="fb3" href="{{ url ('https://www.instagram.com/'.$profile->instagram)}}" style="border-bottom-style: solid; color: #f7659b;"> 
                <img src="{{ url('svg/instagram.svg') }}" style="width: 20px; height: 23px"></a>
...
<br>
        ...
        <div id="objective">
            <p>
                Dirección: <span class="tel">
                    {{$profile->direccion}}</span>
            </p>
            <img src="{{ asset ('/images/'.$profile->avatar)}}" style="margin-left: 530px; margin-top: -280px; width: 240px; height: 300px; padding: 10px 10px 20px 10px;
 ...
 <table style="border-spacing:4px; text-align:left; width: 100%;border-collapse: collapse;">
             ...
             <tbody>
              ...
              <a href="{{action('profileController@edit', $profile->id)}}"> <p style="margin-right: 400px"><br><br><button style="/* Green */
