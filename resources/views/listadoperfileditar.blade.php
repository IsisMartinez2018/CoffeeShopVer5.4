...
<script>
    ...
    <!-- Custom-Files -->
    <link rel="stylesheet" href="{{ url('css/bootstrap(2).css')}}">
    <!-- Bootstrap-Core-CSS -->
    <!-- Flexslider-CSS -->
    <link rel="stylesheet" href="{{ url('css/style(2).css')}}" type="text/css" media="all" />
    <!-- Style-CSS -->
    <link rel="stylesheet" href="{{ url('css/fontawesome-all(2).css')}}">
...
@endif
  ...
  {{csrf_field()}}
        ...
        <div id="contact-info" class="vcard">
            ...
            <div style="text-align:right"><a href="{{ route('profile.index') }}" style="text-decoration: none; color: white"><img src="{{ URL::asset("/images/back.png") }}" style="margin-top:-80px;margin-left: -100px; height: 27px; width: 27px; border:none;">Atrás</a></div>
            ...
            <p>
                ...
                Telefono: <span class="tel">
                    <input type="number" name="tlf" placeholder="{{$profile->tlf}}" value="{{$profile->tlf}}" style="padding: 2px 7px; box-sizing: border-box; border: 2px solid #ccc; border-radius: 4px; background-color: #f8f8f8;">
                </span><br/>
                <br>
                Email: <a class="email">
                    <input type="email" name="email" placeholder="{{$profile->users->email}}" value="{{$profile->email}}" style="padding: 2px 7px; box-sizing: border-box; border: 2px solid #ccc; border-radius: 4px; background-color: #f8f8f8;"></a><br><br>
            </p>
        </div>
        ...
        <div id="objective">
            <p>
                ...
                <input type="text" name="direccion" placeholder="{{$profile->direccion}}" value="{{$profile->direccion}}" style="width: 95%; height: 150px; padding: 12px 20px; box-sizing: border-box; border: 2px solid #ccc; border-radius: 4px; background-color: #f8f8f8;">
                
            </p>
             <img src="{{ asset ('/images/'.$profile->avatar)}}" style="margin-left: 530px; margin-top: -380px; width: 240px; height: 300px; padding: 10px 10px 20px 10px;
    ...
    box-shadow: 10px 10px 5px #aaaaaa;transform: rotate(-8deg);">
        ...
        <dl>
            ...
            <dd>
                <h2>Facebook <img src="{{ url('svg/facebook.svg') }}" style="width: 20px; height: 23px;border-bottom-style: solid; color: #007bff;"></h2>
                /<input type="text" name="facebook" placeholder="{{$profile->facebook}}" value="{{$profile->facebook}}" style="padding: 2px 7px;  border: 2px solid #ccc; border-radius: 4px; background-color: #f8f8f8;">
                <h2>Twitter <img src="{{ url('svg/twitter.svg') }}" style="width: 20px; height: 23px;border-bottom-style: solid; color: #3bbef5;"></h2>
                @<input type="text" name="twitter" placeholder="{{$profile->twitter}}" value="{{$profile->twitter}}" style="padding: 2px 7px; box-sizing: border-box; border: 2px solid #ccc; border-radius: 4px; background-color: #f8f8f8;">
                <h2>Google+ <img src="{{ url('svg/google-plus.svg') }}" style="width: 20px; height: 23px;border-bottom-style: solid; color: #ea5d4b;"></h2>
                @<input type="text" name="google" placeholder="{{$profile->google}}" value="{{$profile->google}}" style="padding: 2px 7px; box-sizing: border-box; border: 2px solid #ccc; border-radius: 4px; background-color: #f8f8f8;">
                <h2>Instagram <img src="{{ url('svg/instagram.svg') }}" style="width: 20px; height: 23px;border-bottom-style: solid; color: #f7659b;"></h2>
                @<input type="text" name="instagram" placeholder="{{$profile->instagram}}" value="{{$profile->instagram}}" style="padding: 2px 7px; box-sizing: border-box; border: 2px solid #ccc; border-radius: 4px; background-color: #f8f8f8;">
            </dd>
...
<!-- JavaScript -->
    ...
    <script src="{{ url('js/coffee.js')}}"></script>
